  ...
  class Connection
    ...
    def ship(shipment_builder = {}, &block)
      ...
      if parsed_confirm_response.success?
        ship_accept_builder = UPS::Builders::ShipAcceptBuilder.new.tap do |builder|
          builder.add_access_request shipment_builder.license_number, shipment_builder.user_id, shipment_builder.password
          builder.add_shipment_digest parsed_confirm_response.shipment_digest
        end
